<template><h2 id="创建变量赋值" tabindex="-1"><a class="header-anchor" href="#创建变量赋值" aria-hidden="true">#</a> 创建变量赋值</h2>
<p>变量名 = 存储在变量中的值</p>
<p>x = 10</p>
<hr>
<p>多个变量赋值赋同一个值</p>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code>a<span class="token operator">=</span>b<span class="token operator">=</span>c<span class="token operator">=</span><span class="token number">10</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><p>多个变量赋不同的值</p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br></div></div><h2 id="数据类型" tabindex="-1"><a class="header-anchor" href="#数据类型" aria-hidden="true">#</a> 数据类型</h2>
<p>什么是数据类型？存储在变量中的值的类型</p>
<ul>
<li>
<p>Number（数字）  ：包括int、float、bool、complex（复数）</p>
<table>
<thead>
<tr>
<th>Number类型细分</th>
...
<li>
<p>String（字符串）</p>
<p>用单引号 <strong>'</strong> 或双引号 <strong>&quot;</strong> 括起来的字符，比如“hello world”，‘02’，‘您好’</p>
</li>
<li>
<p>List（列表）</p>
<p>列表是写在方括号 <strong>[]</strong> 之间、用逗号分隔开的元素列表。[元素，元素，元素]。元素可以是数据，也可以是字符串，甚至可以是列表。</p>
<p>比如: [1,2,&quot;你好&quot;]     [1,2,&quot;你好&quot;，['hhh']]</p>
</li>
<li>
<p>Tuple（元组）</p>
<p>元组写在小括号 <strong>()</strong> 里，元素之间用逗号隔开。(元素，元素)。元素可以是数据，也可以是字符串。</p>
<p>比如: ( 'abcd', 786 , 2.23, 'runoob', 70.2 )</p>
</li>
<li>
<p>Set（集合）</p>
<p>可以使用大括号 <strong>{ }</strong> 或者 <strong>set()</strong> 函数创建集合,输出会去除重复元素</p>
<p>比如: sites = {'Google', 'Taobao', 'Runoob', 'Facebook', 'Zhihu', 'Baidu'}</p>
<p>使用print(sites)输出，为{'Zhihu', 'Runoob', 'Google', 'Facebook', 'Baidu', 'Taobao'}</p>
<p>比如： a = set('abracadabra')</p>
<p>使用print(a)输出，为{'b', 'a', 'd', 'c', 'r'}</p>
</li>
<li>
<p>Dictionary（字典）</p>
</li>
...
<p>​      字典当中的元素是通过键来存取的。</p>
<p>​      比如：dict = {}    dict['one'] = &quot;您好&quot;   one是键，您好是键对应的值</p>
<p>​      比如：tinydict = {'one': '您好','code':1}</p>
<h2 id="注释" tabindex="-1"><a class="header-anchor" href="#注释" aria-hidden="true">#</a> 注释</h2>
<p>在代码中遇到下面这部分是注释，就是你的笔记，可以不用管</p>
...
<td style="text-align:left">9//2 值是4.5在4和5之间，取小的值,4      -9//2  值是-4.5在-5和-4之间，取小的值，-5</td>
</tr>
</tbody>
</table>
...
<tr>
<td style="text-align:left">:=</td>
<td style="text-align:left">海象运算符，可在表达式内部为变量赋值。</td>
<td style="text-align:left">猜你们课本太老，肯定不考这个</td>
</tr>
</tbody>
</table>
<h2 id="逻辑运算符" tabindex="-1"><a class="header-anchor" href="#逻辑运算符" aria-hidden="true">#</a> 逻辑运算符</h2>
<p>假设变量 a 为 10, b为 20:</p>
<p>记住：数值和true,false的对应关系     0为false , 不是0的为true</p>
<table>
<thead>
<tr>
<th style="text-align:left">运算符</th>
...
<h2 id="操作运算符" tabindex="-1"><a class="header-anchor" href="#操作运算符" aria-hidden="true">#</a> 操作运算符</h2>
<table>
<thead>
<tr>
...
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code><span class="token keyword">if</span> condition_1<span class="token punctuation">:</span>
    statement_block_1
